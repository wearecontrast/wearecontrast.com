  ...
  <div class="row row--flex">
    <div class="small-12 medium-8 columns">
      <div class="c_project-detail__main">
        <h2><a href="https://outstandingbar.com/" target="_blank">Outstanding Bar <i class="fa fa-external-link"></i></a></h2>
        ...
        <ul class="o_undercover-list c_project-detail__related">
          <li><a href="https://outstandingbar.com/" target="_blank">OutstandingBar.com</a></li>
